...
const WORKFLOW_SPECS = [
  {
    ...
    patterns: [
      ...
      "shared/**",
      "scripts/checks/**",
      "scripts/release/verify-attention-shadow-evidence.mjs",
      "scripts/release/verify-attention-shadow-evidence.test.mjs",
      "scripts/smoke/owner-attention-probe.mjs",
      "scripts/smoke/owner-attention-probe.test.mjs",
      "scripts/smoke/with-staging-owner-session.mjs",
      "scripts/smoke/with-staging-owner-session.test.mjs",
      "supabase/**",
      "scripts/supabase/**",
      "migration-*.sql",
      ".github/workflows/api-ci.yml",
      ".github/workflows/g1-launch-smoke.yml",
    ],
  },
  {
