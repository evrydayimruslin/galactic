...
export const PLATFORM_MCP_ALIAS_MAP: Record<string, PlatformMcpAliasInfo> = {
  'ul.discover.desk': {
    canonicalTool: 'gx.discover',
    replacement: 'gx.discover({ scope: "desk" })',
  },
  'ul.discover.inspect': {
    canonicalTool: 'gx.discover',
    replacement: 'gx.discover({ scope: "inspect", app_id })',
  },
  'ul.discover.library': {
    canonicalTool: 'gx.discover',
    replacement: 'gx.discover({ scope: "library", query? })',
  },
  'ul.discover.appstore': {
    canonicalTool: 'gx.discover',
    replacement: 'gx.discover({ scope: "appstore", query?, task? })',
  },
  'ul.set.version': {
    canonicalTool: 'gx.set',
    replacement: 'gx.set({ app_id, version })',
  },
  'ul.set.visibility': {
    canonicalTool: 'gx.set',
    replacement: 'gx.set({ app_id, visibility })',
  },
  'ul.set.download': {
    canonicalTool: 'gx.set',
    replacement: 'gx.set({ app_id, download_access })',
  },
  'ul.set.supabase': {
    canonicalTool: 'gx.set',
    replacement: 'gx.set({ app_id, supabase_server })',
  },
  'ul.set.ratelimit': {
    canonicalTool: 'gx.set',
    replacement: 'gx.set({ app_id, calls_per_minute?, calls_per_day? })',
  },
  'ul.set.pricing': {
    canonicalTool: 'gx.set',
    replacement: 'gx.set({ app_id, default_price_light?, default_free_calls?, function_prices? })',
  },
  'ul.permissions.grant': {
    canonicalTool: 'gx.permissions',
    replacement: 'gx.permissions({ app_id, action: "grant", ... })',
  },
  'ul.permissions.revoke': {
    canonicalTool: 'gx.permissions',
    replacement: 'gx.permissions({ app_id, action: "revoke", ... })',
  },
  'ul.permissions.list': {
    canonicalTool: 'gx.permissions',
    replacement: 'gx.permissions({ app_id, action: "list" })',
  },
  'ul.permissions.export': {
    canonicalTool: 'gx.permissions',
    replacement: 'gx.permissions({ app_id, action: "export", format?, since?, until?, limit? })',
  },
  'ul.connect': {
    canonicalTool: 'gx.secrets',
    replacement: 'gx.secrets({ app_id, secrets })',
  },
  'ul.connections': {
    canonicalTool: 'gx.secrets',
    replacement: 'gx.secrets({ app_id? })',
  },
  'ul.memory.read': {
    canonicalTool: 'gx.memory',
    replacement: 'gx.memory({ action: "read", owner_email? })',
  },
  'ul.memory.write': {
    canonicalTool: 'gx.memory',
    replacement: 'gx.memory({ action: "write", content, append? })',
  },
  'ul.memory.append': {
    canonicalTool: 'gx.memory',
    replacement: 'gx.memory({ action: "write", content, append: true })',
  },
  'ul.memory.recall': {
    canonicalTool: 'gx.memory',
    replacement: 'gx.memory({ action: "recall", key, value?, scope?, owner_email? })',
  },
  'ul.memory.remember': {
    canonicalTool: 'gx.memory',
    replacement: 'gx.memory({ action: "recall", key, value, scope? })',
  },
  'ul.memory.query': {
    canonicalTool: 'gx.memory',
    replacement: 'gx.memory({ action: "query", prefix?, limit?, owner_email? })',
  },
  'ul.memory.forget': {
    canonicalTool: 'gx.memory',
    replacement: 'gx.memory({ action: "query", delete_key: key, scope? })',
  },
  'ul.markdown.publish': {
    canonicalTool: 'gx.upload',
    replacement: 'gx.upload({ type: "page", slug, content, title?, tags?, shared_with?, published? })',
  },
  'ul.markdown.list': {
    canonicalTool: null,
  ...
  'ul.like': {
    canonicalTool: 'gx.rate',
    replacement: 'gx.rate({ app_id?, content_id?, rating: "like" })',
  },
  'ul.dislike': {
    canonicalTool: 'gx.rate',
    replacement: 'gx.rate({ app_id?, content_id?, rating: "dislike" })',
  },
  'ul.lint': {
    canonicalTool: 'gx.test',
    replacement: 'gx.test({ files, lint_only: true, strict? })',
  },
  'ul.scaffold': {
    canonicalTool: 'gx.download',
    replacement: 'gx.download({ name, description, functions?, storage?, permissions? })',
  },
  'ul.health': {
    canonicalTool: null,
    replacement: 'No canonical replacement published yet.',
