...
| --- | --- | --- | --- | --- | --- | --- |
| Public API hostname | `https://ultralight-api-staging.rgn4jz429m.workers.dev` | `https://api.connectgalactic.com` | `Isolated` | Platform / API | [api/wrangler.toml](../api/wrangler.toml), [docs/RELEASE_TOPOLOGY.md](RELEASE_TOPOLOGY.md) | Separate Worker scripts and origins |
| Launch website hostname | `https://staging.ultralight-launch-web.pages.dev` | `https://connectgalactic.com` | `Isolated` | Launch Web / Release ops | [apps/launch-web/wrangler.toml](../apps/launch-web/wrangler.toml), [`.github/workflows/launch-web-deploy.yml`](../.github/workflows/launch-web-deploy.yml) | Separate Pages branches and origins |
...
| Desktop build channel | deferred | `desktop-v*` only | `Out of launch scope` | Desktop | [`.github/workflows/desktop-release.yml`](../.github/workflows/desktop-release.yml), [docs/LAUNCH_P2_2_CERTIFICATION_2026-07-15.md](LAUNCH_P2_2_CERTIFICATION_2026-07-15.md) | Ordinary `v*` launch tags do not trigger desktop release |
| Desktop pinned API base | `https://ultralight-api-staging.rgn4jz429m.workers.dev` | `https://api.ultralightagent.com` | `Isolated` | Desktop | [desktop/src/lib/environment.ts](../desktop/src/lib/environment.ts) | Production and staging desktop builds reject mismatched API bases |
...
| Legacy `ultralight.dev` hostnames | not used | not used | `Diagnostic only` | Platform / Release ops | [docs/RELEASE_TOPOLOGY.md](RELEASE_TOPOLOGY.md) | `ultralight.dev` is not project-owned; do not use `api.ultralight.dev` or `staging-api.ultralight.dev` as release evidence unless ownership changes |
