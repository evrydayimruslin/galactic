...
export declare const ACTIVE_BYOK_PROVIDER_IDS: readonly [
  "openrouter",
  "openai",
  "deepseek",
  "nvidia",
...
export declare const LEGACY_BYOK_PROVIDER_IDS: readonly [
  "anthropic",
  "moonshot",
];
...
export declare function isActiveBYOKProvider(
  value: unknown,
): value is ActiveBYOKProvider;
export declare function isLegacyBYOKProvider(
  value: unknown,
 ...
 */
export declare function getCallPriceLight(
 ...
 */
export declare function getFreeCalls(
  pricingConfig: AppPricingConfig | null | undefined,
  functionName: string,
): number;
/**
 ...
 */
export declare function getFreeCallsScope(
  pricingConfig: AppPricingConfig | null | undefined,
): "app" | "function";
/**
 ...
 */
export declare function getGpuPricingMode(
 ...
 */
export declare function getGpuPricingUnitLabel(
  gpuPricingConfig: Record<string, unknown> | null | undefined,
): string;
...
export declare const ALLOWED_EXTENSIONS: readonly [
  ".ts",
  ".tsx",
  ".js",
  ".jsx",
...
export declare const BYOK_PROVIDERS: Record<
  ActiveBYOKProvider,
  BYOKProviderInfo
>;
/**
...
export declare function normalizeManifestEnvVars(
  envVars: unknown,
): Record<string, ManifestEnvVar> | undefined;
export declare function getManifestEnvVars(
  manifest:
    | {
      env?: unknown;
      env_vars?: unknown;
...
export declare function manifestEnvVarsToEnvSchema(
  envVars: Record<string, ManifestEnvVar> | undefined,
): Record<string, EnvSchemaEntry>;
export declare function resolveManifestEnvSchema(
  manifest:
    | {
      env?: unknown;
      env_vars?: unknown;
...
export declare function normalizeEnvSchema(
  input: unknown,
): Record<string, EnvSchemaEntry>;
 ...
 */
export declare function normalizeManifestParameters(
  params: unknown,
 ...
 */
export declare function manifestToMCPTools(
  manifest: AppManifest,
  _appId: string,
  appSlug: string,
): MCPTool[];
