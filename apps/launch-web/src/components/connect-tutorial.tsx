...
const tutorialInstruction: Record<ConnectTutorialIntent, string> = {
  connect:
    "Copy this prompt into your coding agent to connect it to your Galactic workspace.",
  agent:
    "Copy this prompt into your coding agent. It will help define and stage a new persistent Agent for your review.",
  interface:
    "Copy this prompt into your coding agent. It is scoped to the selected Agent and guides a safe interface addition.",
  function:
    "Copy this prompt into your coding agent. It is scoped to the selected Agent and guides a safe function addition.",
  routine:
    "Copy this prompt into your coding agent. It is scoped to the selected Agent and guides a safe routine addition.",
};
